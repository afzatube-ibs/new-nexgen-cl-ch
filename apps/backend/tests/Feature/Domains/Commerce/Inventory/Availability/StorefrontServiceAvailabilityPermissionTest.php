...
it('grants the storefront service only the aggregate inventory permission needed for availability composition', function () {
    ...
    expect($keys)->toContain('inventory.availability.view');
    expect($keys)->not->toContain('inventory.stock.view');
