...
namespace App\Domains\Operations\Returns\Models\Concerns;

use App\Domains\Operations\Returns\Exceptions\ConcurrencyConflictException;

/**
 * DATA:VERSIONING made concrete for this module — see Fulfillment's or
 * Shipping's identically-shaped trait for the full rationale (each module
 * owns its own copy per MODULE:PUBLIC_CONTRACT).
 */
