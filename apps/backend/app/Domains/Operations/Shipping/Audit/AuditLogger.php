...
namespace App\Domains\Operations\Shipping\Audit;

use Illuminate\Support\Facades\Context;

/**
 * The single place Shipping writes audit records, per DATA:AUDIT_DATA —
 * every mutation to a ShippingZone, ShippingMethod, or ShippingRate is
 * audited, mirroring Pricing's own AuditLogger exactly.
 *
