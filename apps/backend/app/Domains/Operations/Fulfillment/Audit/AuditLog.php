...
namespace App\Domains\Operations\Fulfillment\Audit;
 ...
 * fulfillment_audit_logs migration's docblock. Immutable: no `updated_at`,
...
final class AuditLog extends Model
{
    ...
    protected $table = 'fulfillment_audit_logs';
