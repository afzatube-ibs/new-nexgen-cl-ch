...
/**
 * DATA:AUDIT_DATA / SECURITY:AUDIT_LOGGING's record for this module —
 * mirrors `StoreConfiguration\Audit\AuditLog` exactly. Written only
 * through AuditLogger.
 *
 * @property string $id
...
final class AuditLog extends Model
{
    ...
    protected $table = 'appearance_audit_logs';
