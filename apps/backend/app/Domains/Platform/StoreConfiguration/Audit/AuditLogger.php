...
/**
 * The single place Store Configuration writes audit records, per
 * DATA:AUDIT_DATA's "every module's audit records follow the same
 * structural expectation" and this module's own Security Considerations
 * entry in planning/IMPLEMENTATION_MASTER_PLAN.md ("Configuration changes
 * are audited per SECURITY:AUDIT_LOGGING").
 *
