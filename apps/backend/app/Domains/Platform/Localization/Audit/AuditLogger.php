...
namespace App\Domains\Platform\Localization\Audit;

use Illuminate\Support\Facades\Context;

/**
 * The single place Localization & Currency writes audit records, per
 * DATA:AUDIT_DATA and this module's own Security Considerations entry in
 * planning/IMPLEMENTATION_MASTER_PLAN.md ("any rate source must be
 * auditable").
 *
