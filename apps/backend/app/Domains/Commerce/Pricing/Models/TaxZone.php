...
/**
 * A geographic tax jurisdiction — see the tax_zones migration's docblock,
 * including why `region` is an empty string rather than null for a
 * country-wide zone.
 *
 * @property string $id
 ...
 */
final class TaxZone extends Model
{
