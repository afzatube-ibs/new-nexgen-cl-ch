...
/**
 * DATA:VERSIONING made concrete for this module — see other modules'
 * identically-shaped exception for the full rationale (each module owns
 * its own copy per MODULE:PUBLIC_CONTRACT). Mapped to HTTP 409 in
 * bootstrap/app.php.
 */
