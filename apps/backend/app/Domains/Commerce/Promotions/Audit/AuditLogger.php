...
namespace App\Domains\Commerce\Promotions\Audit;

use Illuminate\Support\Facades\Context;

/**
 * The single place Promotions writes audit records, per DATA:AUDIT_DATA and
 * this module's own Security Considerations entry in planning/
 * IMPLEMENTATION_MASTER_PLAN.md ("Coupon abuse ... requires the same rigor
