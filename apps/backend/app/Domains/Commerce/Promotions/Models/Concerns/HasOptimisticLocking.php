...
namespace App\Domains\Commerce\Promotions\Models\Concerns;

use App\Domains\Commerce\Promotions\Exceptions\ConcurrencyConflictException;

/**
 * DATA:VERSIONING made concrete for this module — see Pricing's identically
 * -shaped trait for the full rationale (each module keeps its own copy per
 * MODULE:PUBLIC_CONTRACT).
 */
