 ...
 * the catalog_audit_logs migration's docblock for why this is immutable
 * and why it is a separate table from every other module's own audit log.
 * Written only through AuditLogger, never constructed and saved ad hoc
 * elsewhere.
 *
 * @property string $id
