...
{
    /**
     * Customers' own audit trail — a separate table from every other
     ...
     * code path exists anywhere in this module. Customer data is Sensitive
     * per DATA:CLASSIFICATION, per this module's own Security
     * Considerations entry in the master plan — reads are audited here,
     * not only mutations, mirroring Identity & Access's own precedent for
     * its equally-Sensitive user data.
     */
